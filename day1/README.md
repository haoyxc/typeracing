# Exercise 1: Videos (Watch me!)

1. Learn about redux from its author, Dan Abramov: [Redux Tutorials](https://egghead.io/courses/getting-started-with-redux)

1. Color Toggle: [Video](https://vimeo.com/282271903); [Codepen](https://codepen.io/ariabuckles/pen/YjYYZx?editors=0010)

1. Simple Counter: [Video](https://vimeo.com/282272060); [Codepen](http://codepen.io/rick-shar/pen/qrBwRz)

1. Canvas From Scratch: [Video](https://vimeo.com/282272156); [Finished codepen](https://codepen.io/smitgw11/pen/oGqEEr?editors=1010)

1. Connecting Components with react-redux: [Video](https://vimeo.com/282278132); [Finished codepen](https://codepen.io/rick-shar/pen/mmYxGP?editors=0011)
...
[Todo App: React with Redux](https://github.com/horizons-school-of-technology/todo-redux/)
