...
const ppl = [
  {
    ...
    lName: "Patil",
    number: "(921)-664-2091",
    email: "nihar@joinhorizons.com"
  },
  {
    fName: "Nihar",
    lName: "Harhar",
    number: "(421)-666-2022",
    email: "puppysmacker94@hotmail.com"
  },
  {
    fName: "Nihar",
    lName: "Kardashian",
    number: "(608)-633-1254",
    email: "kanyebae@tidal.com"
  },
  {
    fName: "Graham",
    lName: "Smith",
  ...
  },
  {
    ...
    lName: "Slam",
    number: "(611)-845-0967",
    email: "cmonandslam@welcometothejam.com"
  },
  {
    fName: "Graham",
    lName: "Master",
    number: "(612)-284-3678",
    email: "senseibaybay@aol.com"
  },
  {
    fName: "Graham",
    lName: "Cracker",
    number: "(616)-824-0567",
    email: "cinnamonbear@yahoo.com"
  },
  {
    fName: "Darwish",
    lName: "Gani",
    number: "(774)-123-6477",
    email: "darwish@joinhorizons.com"
  },
  {
    fName: "Darwish",
    lName: "Gandhi",
    number: "(124)-233-6755",
    email: "saltypeace@india.gov"
  }
];
    ...
    return (
      <div>
        <Route
          ...
          render={() => <Link to="/directory">Back to Directory</Link>}
        />
        <h1>Horizons Directory</h1>
        <Route
          exact
          path="/directory"
          render={() => <LinkList links={ppl.map(pplToFullLink)} />}
        />
  ...
  render() {
    ...
    return person ? (
      <div>
        ...
        <h3>{person.number}</h3>
        <h3>{person.email}</h3>
        Not the {`${person.fName}`} you're looking for? Too bad
